...
import { pbkdf2Verify } from '@/lib/cryptoUtils'; // Use pbkdf2Verify from cryptoUtils

const JWT_SECRET = process.env.JWT_SECRET || 'fallback-secret-key-replace-in-production'; // Ensure this is in your .env.local
